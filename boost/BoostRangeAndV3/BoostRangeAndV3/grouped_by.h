...
namespace boost
{
    namespace range_detail
    {
        namespace view
        {
            ...
            {
                typedef
                    typename group_by_iterator_base_gen< Pred, Iter >::base_t
                        super_t;
            ...
            public:
                ...
                : iterator_range(
                      iterator( p, boost::begin( r ), boost::end( r ) ),
                ...
                const group_by_holder< BinPredicate >& pred )
            {
                ...
                return group_by_range< BinPredicate, ForwardRng >( pred.val,
                                                                   rng );
            }
    ...
    namespace view
    {
        using range_detail::view::group_by_range;
    }
    ...
    namespace adaptors
    {
        namespace view
        {
            using boost::range_detail::view::group_by_range;

            namespace
            {
                const range_detail::forwarder<
                    range_detail::view::group_by_holder > grouped_by =
                    range_detail::forwarder<
                        range_detail::view::group_by_holder >();
            }
                ...
                BinPredicate group_by_pred )
            {
                ...
                return view::group_by_range< BinPredicate, ForwardRng >(
                    group_by_pred, rng );
            }
                ...
                BinPredicate group_by_pred )
            {
                ...
                return view::group_by_range< BinPredicate, const ForwardRng >(
                    group_by_pred, rng );
            }
        } // namespace 'view'
    }     // namespace 'adaptors'
