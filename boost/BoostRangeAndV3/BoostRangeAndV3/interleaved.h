...
namespace boost
{
    namespace range_detail
    {
        namespace view
        {
            ...
            {
                typedef typename interleave_iterator_base_gen< Iter >::base_t
                    super_t;
                typedef
                    typename interleave_iterator_base_gen< Iter >::sub_iter_t
                        sub_iter_t;
            ...
            public:
                ...
                {
                    for ( auto& sub_range : make_iterator_range( it, last ) )
                    {
            ...
            struct interleave_range
                : iterator_range< interleave_iterator<
    ...
    namespace view
    {
        using range_detail::view::interleave_range;
    }
    ...
    namespace adaptors
    {
        namespace view
        {
            using boost::range_detail::view::interleave_range;

            namespace
            {
                const range_detail::view::interleave_forwarder interleaved =
                    range_detail::view::interleave_forwarder();
            }
