...
namespace boost
{
    namespace range_detail
    {
        ...
        class join_iterator : public join_iterator_base_gen< Iter >::base_t
        {
            ...
            typedef
                typename join_iterator_base_gen< Iter >::sub_iter_t sub_iter_t;
        ...
        public:
            ...
            join_iterator()
            : m_it(), m_last(), m_is_it_valid( false ), m_sub_it(), m_sub_last()
            {
            }
        ...
        private:
            ...
            {
                BOOST_ASSERT( m_it_valid != other.m_it_valid || !m_it_valid ||
                              m_it == other.m_it ||
                              m_sub_last == other.m_sub_last );

                return m_it_valid == other.m_it_valid &&
                       ( !m_it_valid ||
                         ( m_it == other.m_it && m_sub_it == other.m_sub_it ) );
            }
            ...
            void ensure_valid_sub_it_or_last()
            {
                while (m_it_valid && m_sub_it == m_sub_last)
                {
                    m_it_valid = (++m_it != m_last);
                    m_sub_it =
                        (m_it_valid ? boost::begin(*m_it) : sub_iter_t());
                    m_sub_last =
